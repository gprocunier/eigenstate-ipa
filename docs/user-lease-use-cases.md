...
<a href="/how-to/open-temporary-access-window.html"><kbd>Open the new page</kbd></a>

Canonical target: [/how-to/open-temporary-access-window.html](/how-to/open-temporary-access-window.html)

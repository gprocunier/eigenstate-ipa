...
<a href="/how-to/query-principal-state.html"><kbd>Open the new page</kbd></a>

Canonical target: [/how-to/query-principal-state.html](/how-to/query-principal-state.html)

...
<a href="/reference/modules/vault_write.html"><kbd>Open the new page</kbd></a>

Canonical target: [/reference/modules/vault_write.html](/reference/modules/vault_write.html)
